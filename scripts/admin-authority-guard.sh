...
SENSITIVE_HANDLERS=(
  ...
  "packages/control-plane/src/serverMigration.ts|handlePostMigrationStart"
  "packages/control-plane/src/serverMigration.ts|handlePostMigrationConfirmReady"
  "packages/control-plane/src/serverMigration.ts|handlePostMigrationAbort"
