...
SOURCE_DATE_EPOCH=$(git log -1 --format=%ct) \
    bash scripts/build-flagship-netboot-iso.sh \
        out/flagship-netboot-debian-13.6.0-x86_64.iso

# 2. Upload to R2.
npx wrangler r2 object put flagship-iso/flagship-netboot-debian-13.6.0-x86_64.iso \
    --file out/flagship-netboot-debian-13.6.0-x86_64.iso
