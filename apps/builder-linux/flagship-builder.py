#!/usr/bin/env python3
"""Flagship Studio Linux GUI — entry point.

A GTK4 + libadwaita wrapper around the `@flagship/builder` Node CLI.
Mirrors apps/builder-mac/ UX 1:1: one window, 5-step wizard, drag-drop
...
def _bail(msg: str) -> int:
    sys.stderr.write(f"flagship-builder: {msg}\n")
    return 2
...
def main(argv: list[str]) -> int:
    ...
    app = Adw.Application(application_id="com.flagshipserver.Builder")
