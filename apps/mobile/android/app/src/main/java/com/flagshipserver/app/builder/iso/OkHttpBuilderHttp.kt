// Real [BuilderHttp] over OkHttp — the production transport for the builder's ISO
...
class OkHttpBuilderHttp(
    private val client: OkHttpClient = defaultClient(),
) : BuilderHttp {
    override suspend fun postJson(url: String, jsonBody: String): BuilderHttpResult = withContext(Dispatchers.IO) {
        ...
        client.newCall(req).execute().use { resp ->
            BuilderHttpResult(resp.code, resp.body?.string() ?: "")
        }
    }
