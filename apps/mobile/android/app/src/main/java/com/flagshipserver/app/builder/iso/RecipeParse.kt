// Parse + light-validate a phone-signed recipe JSON for the on-device builder.
//
// The builder receives the recipe as a JSON string (the same artifact the
// website's "Copy/Download recipe" produces and the desktop builder's loadBlob
