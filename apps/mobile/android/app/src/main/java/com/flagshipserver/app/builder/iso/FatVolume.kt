...
//
// Every viable on-device remaster mechanism (OTG-BUILDER-NOTES.md §3(b)) drops
...
// (packages/flagship-builder `buildDebianPreseed`), never a Kotlin
// re-implementation of the signed bootstrap path (OTG-BUILDER-NOTES.md §5). This
