...
// (OTG-BURNER-NOTES.md §3(b)/§5): chain the canonical preseed generator
...
// flow (BurnerOnDeviceViewModel / IsoInjector): the USB *placement* of this FAT
...
// out of scope here (OTG-BURNER-NOTES.md §5 items 1 + 3). Until they land, this
