...
/// a pure-C# reimplementation of packages/flagship-builder loadBlob +
/// @flagship/protocol verifyInstallBlob, mirroring
/// apps/builder-mac Recipe.swift byte-for-byte. The canonical-byte layout
...
/// <summary>
/// Which assembly flow the wizard runs. Mirrors apps/builder-mac BuilderMode.swift
/// and apps/builder-linux's BuilderMode.
///
/// - Simple (default): the user supplies only a recipe. The builder fetches the
