...
public class CliLocatorTests
{
    ...
    {
        var path = @"C:\repo\flagship\packages\flagship-builder\src\cli.ts";
    ...
    {
        // Simulate: app exe in
        //   C:\Users\foo\flagship\apps\builder-windows\bin\Debug\net8.0-windows\
        // → walk up to flagship\, then over to packages\.
        var execDir = @"C:\Users\foo\flagship\apps\builder-windows\bin\Debug\net8.0-windows";
        var expected = @"C:\Users\foo\flagship\packages\flagship-builder\src\cli.ts";
    ...
    {
        var execDir = @"C:\repo\flagship\apps\builder-windows\bin\Release\net8.0-windows";
        var expected = @"C:\repo\flagship\packages\flagship-builder\dist\cli.js";
    ...
    public void FindEntry_BundledAlongsideExeFallback()
    {
        ...
        var execDir = @"C:\Program Files\Flagship Studio";
        var expected = Path.Combine(execDir, "flagship-builder", "src", "cli.ts");
        var got = CliLocator.FindEntry(Env(),
            p => p == expected,
            executableDir: execDir);
        Assert.Equal(expected, got);
