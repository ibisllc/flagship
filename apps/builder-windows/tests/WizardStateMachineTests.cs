...
public class WizardStateMachineTests
{
    ...
    public void NewState_Simple_HasNothingReady()
    {
        ...
        Assert.Equal(BuilderMode.Simple, s.Mode);
    ...
    {
        var s = new WizardStateView { Mode = BuilderMode.Advanced };
        Assert.False(s.CanBake);
        Assert.False(s.HasRecipe);
    ...
    {
        var s = new WizardStateView { Mode = BuilderMode.Advanced, RecipePath = @"C:\tmp\recipe.json" };
        Assert.False(s.CanBake);
...
internal sealed class WizardStateView
{
    ...
    public BuilderMode Mode { get; set; } = BuilderMode.Simple;
...
public class BuilderModeRules
{
    ...
    public void AdvancedMode_RequiresUserIso()
        => Assert.True(BuilderMode.Advanced.RequiresUserISO());

    [Fact]
    public void BothModes_RequireRecipe()
    {
        Assert.True(BuilderMode.Simple.RequiresRecipe());
        Assert.True(BuilderMode.Advanced.RequiresRecipe());
    }

    [Fact]
    public void MenuLabels_AreSimpleAndAdvanced()
    {
        Assert.Equal("Simple", BuilderMode.Simple.MenuLabel());
        Assert.Equal("Advanced", BuilderMode.Advanced.MenuLabel());
    }

    [Fact]
    public void BakeCtaLabels_DifferByMode()
    {
        Assert.Equal("Flash to USB", BuilderMode.Simple.BakeCtaLabel());
        Assert.Equal("Assemble and flash", BuilderMode.Advanced.BakeCtaLabel());
    }
}
