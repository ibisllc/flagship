...
/// the SERVER decides. On every `ensure()` the builder inspects whatever ISO it
...
public struct IsoBaseCache {
    ...
    private let builderVersion: String
    ...
    public init(client: IsoManifestClient = IsoManifestClient(),
                builderVersion: String = IsoBaseCache.defaultBuilderVersion(),
                arch: IsoArch = .amd64,
    ...
    public static func defaultBuilderVersion() -> String {
    ...
    public static func cacheDir() throws -> URL {
        ...
        let dir = caches.appendingPathComponent("flagship-builder", isDirectory: true)
