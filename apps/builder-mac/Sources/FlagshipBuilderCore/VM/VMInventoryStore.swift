...
public struct VMBundleLayout: Sendable, Equatable {
    ...
    /// Production default: ~/Library/Application Support/FlagshipBuilder/VMs.
    public static func defaultRoot() -> URL {
        let appSupport = FileManager.default.urls(for: .applicationSupportDirectory,
                                                  in: .userDomainMask).first
            ?? FileManager.default.homeDirectoryForCurrentUser
                .appendingPathComponent("Library/Application Support")
        return appSupport.appendingPathComponent("FlagshipBuilder/VMs", isDirectory: true)
    }
...
public final class VMInventoryStore {
    ...
    /// `apps/builder-windows` `VMInventoryStore.IsValidName`; both are pinned by
