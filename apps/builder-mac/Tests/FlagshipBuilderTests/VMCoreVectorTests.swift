...
/// contract that keeps this Swift core and the C# core in apps/builder-windows
/// identical, the same role engine/golden/preseed-vectors.json plays for the
/// preseed engine. Mirrors apps/builder-windows/tests/VMCoreVectorTests.cs one
...
final class VMCoreVectorTests: XCTestCase {
    ...
    private static func vectorsURL() -> URL {
        // .../apps/builder-mac/Tests/FlagshipBuilderTests/VMCoreVectorTests.swift
        //   → .../FlagshipBuilderTests → .../Tests → .../builder-mac → .../apps
