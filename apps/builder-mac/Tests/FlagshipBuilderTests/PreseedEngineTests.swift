...
/// Proves the macOS builder's JavaScriptCore run of the SINGLE canonical
/// preseed / user-data generator is byte-for-byte identical to Node, across the
/// shared golden vectors (`packages/flagship-builder/engine/golden/
...
final class PreseedEngineTests: XCTestCase {
    ...
    /// Drift guard: the JS the builder ships as an SPM resource must be a verbatim
    ...
    func testShippedResourceMatchesCanonicalSource() throws {
        ...
        // This test file lives at apps/builder-mac/Tests/FlagshipBuilderTests/.
        // The canonical bundle is at packages/flagship-builder/engine/ from repo
        ...
        let canonicalURL = here
            ...
            .appendingPathComponent("packages/flagship-builder/engine/preseed-engine.js")
