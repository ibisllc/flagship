...
Mirrors apps/burner-mac/Tests/FlagshipBurnerTests/DiskEnumeratorTests.swift
+ packages/flagship-burner/tests/devices.test.ts. Tests run via:

    python -m pytest apps/burner-linux/tests/
"""
