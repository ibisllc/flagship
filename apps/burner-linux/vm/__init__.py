"""Pure VM-appliance host core for the Linux burner.
...
The layering mirrors apps/burner-windows/src/VM (the closest analog — both are
QEMU-based):
...
it drives the shared `flagship-burn pair --emit-events` CLI, not a VM.
