...
The Linux burner does NOT re-implement the phone-signature verification in
Python (that stays delegated to the Node `flagship-burn verify` CLI, the trust
...
Mirrors:
  * apps/burner-windows/src/VM/RecipeSiblings.cs  (debug_grant)
  * apps/burner-windows/src/Recipe.cs field reading + NormalizeEnvelope
