...
**2026-07-21 (WIP checkpoint — long-lived feature-branch refresh).** The
browser-extension branch was merged with main and remained an isolated docs-only
feature, but main advanced again afterward. This retail branch now carries a
