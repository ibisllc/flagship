...
export class InMemoryAlertInbox implements AlertInbox {
   ...
   */
  private isDuplicate(alert: PhoneUpdateAlert): boolean {
    return this.events.some((e) => sameIdentity(e.alert, alert));
  }
}

function sameIdentity(a: PhoneUpdateAlert, b: PhoneUpdateAlert): boolean {
