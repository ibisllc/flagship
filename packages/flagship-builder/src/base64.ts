 ...
 *   - Node (the Linux/Windows CLI builder) — has Buffer,
 *   - JavaScriptCore (the macOS/iOS builder) — pure ECMAScript, NO Buffer/btoa/TextEncoder,
 *   - Rhino (the Android builder) — pure ECMAScript, same lack.
 *
