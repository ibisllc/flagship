/**
 * cloud-init `user-data` generator for the Builder.
 *
 ...
 * so it can `systemctl start` the daemon immediately. The Builder runs
...
export interface UserDataOptions {
   ...
   * Face ID when the user approves the builder's "Debug mode" toggle. Embedded
...
# hub ("rootEntitlement signature failed verification"). The real (Builder)
